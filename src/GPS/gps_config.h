...
// Hard cap used by gps_sample_quality to reject impossible Doppler speeds.
constexpr int MAX_GPS_SPEED_OK = 40;   // m/s

// Run detector timing. A new run must remain separated by this many seconds.
constexpr int TIME_DELAY_NEW_RUN = 10;

// Unit helpers. Metric classes store speeds in mm/s or cm/s; display/storage
// code converts to knots at the edges.
