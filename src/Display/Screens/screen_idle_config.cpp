...
void draw_IDLE()
{
  ...
  drawCenteredText("Short: GPS", Layout::ROW9(4), Fonts::Body9);
  drawCenteredText("Hold: Config", Layout::ROW9(5), Fonts::Body9);
  drawCenteredText("Auto sleep after 30s", Layout::ROW9(7), Fonts::Body9);
}
